...
import (
	...
	"github.com/IBM/ibm-secretshare-operator/pkg/apis"
	"github.com/IBM/ibm-secretshare-operator/pkg/controller"
	"github.com/IBM/ibm-secretshare-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "secretshare-lock")
	if err != nil {
		klog.Error(err, "")
		os.Exit(1)
	}
