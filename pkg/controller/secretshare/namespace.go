...
func (r *ReconcileSecretShare) ensureNs(ns string) error {
...
func (r *ReconcileSecretShare) getNs(ns string) error {
...
func (r *ReconcileSecretShare) createNs(ns string) error {
	targetNs := &corev1.Namespace{}
	targetNs.SetName(ns)
